...
| 3 | limit-clamp extremes untested (BH-07) | Two tests. Store-level (`limit: 0 / -5 / 1000`) because the route clamps as well and would hide a store regression; HTTP-level asserting out-of-range and unparseable answer 200, never 400/500. Bites: dropping the store's floor/ceiling fails the store test — 1 fail, restored to 19 pass. |
